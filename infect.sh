...
echo -e '\e[93m               
                         __________
                      .A SPAMMER CAN FUCK YOUR GANGDOM.
                    ********************************************
                  D4P3U NEVER AFRAID TO ANYONE
   FUCK SANI AND SAIFULS MOM
    FUCK SANI AND SAIFULS MOM
    FUCK SANI AND SAIFULS MOM
    FUCK SANI AND SAIFULS MOM
    XXFUCK SANI AND SAIFULS MOM
 FUCK SANI AND SAIFULS MOM
XFUCK SANI AND SAIFULS MOM
X |.....X  @#%,.@     |######%%;;;;,.|     @#%,.@  X.....| X'
...
echo -e '\e[92m 
                    ...
                    D4P3U 
echo " "
echo -e "\e[91m 😈  Created😀 By Asif Dipu😀.Heres A link That can infect 
your victims android phone very critically 
device it will be factory reset and All Data Will be Reset
                                👇👇👇
